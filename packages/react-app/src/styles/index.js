...
const styles = { 
  ...
  headTitle: "text-site-green font-poppins font-black text-5xl tracking-wide",
  ...
  // WalletButton
  walletButton:
  "bg-site-green border-none outline-none px-6 py-2 font-poppins font-bold text-lg text-site-blue rounded-3xl leading-[24px] hover:bg-gray-600 transition-all",
