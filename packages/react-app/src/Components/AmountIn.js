// Amount into the decentralized exchange
  ...
  return (
    <div className={styles.amountContainer}>
        ...
        <div className="relative" onClick={() => setShowList((prevState) => !prevState)}> 
            ...
            {/* Map through each entry and destructure token and token name and index */}
            {/* Return a li with tokens and liquidity pairs */}
            {showList && (
